...
import { Loader2, Upload, AlertCircle, FileIcon, CheckCircle2 } from "lucide-react";
import { toast } from "sonner";

interface FileUploadProps {
    onUploadComplete: (url: string, key: string, fileData: { name: string, size: number, type: string }) => void;
    accept?: string;
    maxSizeMB?: number;
    label?: string;
    className?: string;
